...
public interface PhGoodsService {
    ...
    Page<PhGoods> findAll(String name, Long id, String code, String status, Long merchantId, String merchantBrandId, String type, String category, Long[] gidArr, boolean inOrNot, boolean isLimit, Pageable pageable);
